...
% subsumption relation и решетка типов; связь с системами типов с подтипами (subtyping coerсion); 
% связь с системами множественного наследования
% 
...
% концепт (выражаемый словом) как тип (ср. с Монтегю -- тип как ограничение на сочетаемость, концепт как элемент типа)
% семантическое представление как типизированный объект особой структуры (структура признаков)
% четыре компонента семантического представления -- argument structure, event structure, qualia structure etc.
% три основных механизма -- type coerсion (subtyping как частный случай), selective binding, co-composition
% dotted types, unified types (as orthogonal types)
%
\begin{frame}{План}
