...
\begin{itemize}
    \item 
    \item
	\item Годеман (стр. ...): мы не будем делать различия между формулировкой пучка как пучка непрерывных сечений некоторого накрытия и первой формулировкой.
\end{itemize}
\end{frame}
...
\begin{frame}{Конструкции и понятия (10)}
Гомоморфизм пучков:\\
\medskip
\begin{itemize}
	\item 
